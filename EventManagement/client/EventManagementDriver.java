 ...
 * @author KJ
 */
import control.EventManagementSystem;
import entity.Event;
...
public class EventManagementDriver {
    ...
    private static void addPresetData(EventManagementSystem eventManagementSystem) {
        ...
        // Preset Volunteers
        eventManagementSystem.addVolunteer(new Volunteer("V001", "Alice", "alice@example.com"));
        eventManagementSystem.addVolunteer(new Volunteer("V002", "Bob", "bob@example.com"));
        eventManagementSystem.addVolunteer(new Volunteer("V003", "Jason", "jason@example.com"));
        eventManagementSystem.addVolunteer(new Volunteer("V004", "Sandra", "sandra@example.com"));
